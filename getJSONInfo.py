...
def returnGameInfo(jsonInputFormat):
    ...
    for player in thisGame["team_ct"]["team_players"]:
        ...
        print(player['clutch_count'])
        print(player['clutch_won_count'])
        print(player['clutch_loss_count'])
        print(player['entry_kill_won_count'])
        print(player['entry_kill_loss_count'])
        print(player['entry_hold_kill_won_count'])
        print(player['entry_hold_kill_loss_count'])
        print(player['rank_old'])
        print(player['rank_new'])
        print(player['total_damage_health_done'])
        print(player['total_damage_armor_done'])
        print(player['total_damage_health_received'])
        print(player['total_damage_armor_received'])
        print(player['kill_per_round'])
        print(player['assist_per_round'])
        print(player['death_per_round'])
        print(player['total_time_death'])
        print(player['avg_time_death'])
        print(player['1v1_won_count'])
        print(player['1v2_won_count'])
        print(player['1v3_won_count'])
        print(player['1v4_won_count'])
        print(player['1v5_won_count'])
        print(player['1v1_loss_count'])
        print(player['1v2_loss_count'])
        print(player['1v3_loss_count'])
        print(player['1v4_loss_count'])
        print(player['1v5_loss_count'])
        print(player['1v1_count'])
        print(player['1v2_count'])
        print(player['1v3_count'])
        print(player['1v4_count'])
        print(player['1v5_count'])
